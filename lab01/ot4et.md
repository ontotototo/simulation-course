...
3. При больших шагах (dt ≥ 0.1 с) наблюдается значительная погрешность расчёта из-за накопления ошибки метода Эйлера, имеющего первый порядок точности O(dt). При шаге dt ≤ 0.01 с погрешность становится менее 1%
