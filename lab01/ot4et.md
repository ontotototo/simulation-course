...
4. При уменьшении шага моделирования результаты расчёта сходятся, а различия между траекториями становятся пренебрежимо малы

5. Для данной задачи оптимальный шаг моделирования составляет dt = 0.001–0.01 с — это обеспечивает баланс между точностью и быстродействием. Для более высокой точности можно использовать методы высших порядков, к примеру Рунге-Кутта 4.
